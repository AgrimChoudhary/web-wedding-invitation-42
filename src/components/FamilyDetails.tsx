      ...
      <div className="relative bg-gradient-to-br from-white/95 to-wedding-cream/80 backdrop-blur-sm p-8">
        ...
        <div className="flex items-center justify-center">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-wedding-cream/70 via-wedding-gold/60 to-wedding-blush/50 rounded-full transition-all duration-500 group-hover/btn:from-wedding-gold/70 group-hover/btn:via-wedding-blush/60 group-hover/btn:to-wedding-cream/70"></div>
            ...
            <div className="relative flex items-center gap-2 px-6 py-3 text-wedding-maroon font-semibold text-sm tracking-wide">
              <Crown size={16} className="text-wedding-maroon drop-shadow-md group-hover/btn:rotate-12 transition-transform duration-300" />
