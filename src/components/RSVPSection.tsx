                ...
                {(() => {
                  ...
                  <div className="flex justify-center mb-4 sm:mb-6 px-4">
                    <Button
                      ...
                      className="w-full sm:w-auto bg-gradient-to-r from-wedding-maroon via-wedding-gold to-wedding-maroon text-white font-bold px-4 sm:px-6 md:px-10 py-3 sm:py-3 md:py-4 text-sm sm:text-base md:text-lg rounded-xl sm:rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.4)] hover:shadow-[0_12px_40px_rgba(139,69,19,0.6)] transition-all duration-500 transform hover:scale-105 hover:-translate-y-1 border-2 border-wedding-gold/60 min-h-[48px] sm:min-h-[56px] group relative overflow-hidden before:absolute before:inset-0 before:bg-gradient-to-r before:from-wedding-gold before:via-amber-400 before:to-wedding-gold before:opacity-0 hover:before:opacity-100 before:animate-pulse hover:before:bg-gradient-to-l hover:before:from-wedding-gold hover:before:via-amber-300 hover:before:to-wedding-gold before:transition-all before:duration-700"
                    >
                      {isSubmitting ? (
                        <>
            ...
            <form onSubmit={handleFormSubmit} className="space-y-5">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-6">
                ...
                <Button
                  type="submit"
                  disabled={isSubmitting}
                  className="flex-1 bg-gradient-to-r from-wedding-maroon via-wedding-gold to-wedding-maroon text-white rounded-lg py-2.5 font-bold shadow-[0_6px_20px_rgba(0,0,0,0.3)] hover:shadow-[0_8px_30px_rgba(139,69,19,0.5)] transition-all duration-500 transform hover:scale-105 hover:-translate-y-0.5 border border-wedding-gold/60 disabled:opacity-50 relative overflow-hidden before:absolute before:inset-0 before:bg-gradient-to-r before:from-wedding-gold before:via-amber-400 before:to-wedding-gold before:opacity-0 hover:before:opacity-100 before:animate-pulse hover:before:bg-gradient-to-l hover:before:from-wedding-gold hover:before:via-amber-300 hover:before:to-wedding-gold before:transition-all before:duration-700"
                >
                  {isSubmitting ? (
                    <>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 max-w-2xl mx-auto mb-4 sm:mb-6 px-4">
              {rsvpConfig === 'simple' ? (
                <Button
                  ...
                  disabled={isSubmitting}
                  className="flex-1 bg-gradient-to-r from-wedding-maroon via-wedding-gold to-wedding-maroon text-white font-bold px-4 sm:px-6 md:px-10 py-3 sm:py-3 md:py-4 text-sm sm:text-base md:text-lg rounded-xl sm:rounded-2xl shadow-[0_8px_30px_rgba(0,0,0,0.4)] hover:shadow-[0_12px_40px_rgba(139,69,19,0.6)] transition-all duration-500 transform hover:scale-105 hover:-translate-y-1 border-2 border-wedding-gold/60 min-h-[48px] sm:min-h-[56px] group disabled:opacity-50 relative overflow-hidden before:absolute before:inset-0 before:bg-gradient-to-r before:from-wedding-gold before:via-amber-400 before:to-wedding-gold before:opacity-0 hover:before:opacity-100 before:animate-pulse hover:before:bg-gradient-to-l hover:before:from-wedding-gold hover:before:via-amber-300 hover:before:to-wedding-gold before:transition-all before:duration-700"
                >
                  {isSubmitting ? (
                    <>
                      <svg className="animate-spin -ml-1 mr-2 h-4 w-4 sm:h-5 sm:w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
